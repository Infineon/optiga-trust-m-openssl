...
static const OSSL_ALGORITHM trustm_encoders[] = {
    ...
    {"RSA",
     "provider=trustm,output=der,structure=SubjectPublicKeyInfo",
     trustm_rsa_encoder_SubjectPublicKeyInfo_der_functions},
    {"RSA",
     "provider=trustm,output=pem,structure=SubjectPublicKeyInfo",
     trustm_rsa_encoder_SubjectPublicKeyInfo_pem_functions},
    {"EC", "provider=trustm,output=text", trustm_ec_encoder_text_functions},
    {"EC",
     "provider=trustm,output=der,structure=SubjectPublicKeyInfo",
     trustm_ec_encoder_SubjectPublicKeyInfo_der_functions},
    {"EC",
     "provider=trustm,output=pem,structure=SubjectPublicKeyInfo",
     trustm_ec_encoder_SubjectPublicKeyInfo_pem_functions},
    // dummy private key encoders
    {"RSA",
     "provider=trustm,output=der,structure=PrivateKeyInfo",
     trustm_rsa_encoder_PrivateKeyInfo_der_functions},
    {"RSA",
     "provider=trustm,output=pem,structure=PrivateKeyInfo",
     trustm_rsa_encoder_PrivateKeyInfo_pem_functions},
    {"EC",
     "provider=trustm,output=der,structure=PrivateKeyInfo",
     trustm_ec_encoder_PrivateKeyInfo_der_functions},
    {"EC",
     "provider=trustm,output=pem,structure=PrivateKeyInfo",
...
static int
trustm_get_capabilities(void *provctx, const char *capability, OSSL_CALLBACK *cb, void *arg) {
